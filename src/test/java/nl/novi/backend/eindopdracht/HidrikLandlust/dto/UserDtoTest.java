...
public class UserDtoTest {
    UserDto generatedUser = generateUserDto();
    ...
    void getCorrectUsernameAfterSetting() {
        ...
        assertEquals(generatedUser.getUsername(), "TESTUSER");
    }

    @Test
    void getCorrectPasswordAfterSetting() {
        generatedUser.setPassword("PASSWORD");
        assertEquals(generatedUser.getPassword(), "PASSWORD");
    }
    ...
    void getCorrectEmailAfterSettingFalse() {
        ...
        assertEquals(generatedUser.getEmail(), "TEST.USER.1");
    }
